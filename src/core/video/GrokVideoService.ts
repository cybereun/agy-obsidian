...
import type { AgyObsidianSettings } from '../types';
...
function buildGrokVideoPrompt(vaultRelativePath: string, request: GenerateGrokVideoRequest): string {
  return [
    ...
    '- Do not edit the markdown note; AgyObsidian will embed the video after the file exists.',
